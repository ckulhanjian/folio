...
function Research() {
  return (
    <section id="research" className="section research stack-section">
      <div className="section-reveal research-layout">
        ...
        {/* Centered vertically across the whole column — equidistant
            between the title up top and the section's bottom edge —
            rather than sitting level with any one piece of text. */}
